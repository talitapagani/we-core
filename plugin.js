...
module.exports = function loadPlugin(projectPath, Plugin) {
  ...
  plugin.mapRoute(function(){
// console.log('this', this)
    //this.resource('pages',{ path: '/page'}, function pagesList() {
  //    this.route('create', { path: '/create' } );

      this.resource('page', { path: '/page' } , function PageResource() {

        this.resource('comment', { path: '/comment' } , function CommentResource() {
